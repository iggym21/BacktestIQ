...
[![Tests](https://img.shields.io/badge/tests-116_passing-brightgreen)](#testing)
...
Frontend: 15 Vitest tests covering component behavior (regression guards for the tooltip-label, heatmap-color, and walk-forward "lost money" summary bugs fixed this session, position-sizing form logic) and the axios 401 → redirect-to-login decision logic, plus TypeScript strict mode. Both run in CI on every push.
